// ======================================================================
// MPU-6050-PSoC-CalibrateOffsets.v generated from TopDesign.cysch
// 07/20/2014 at 11:19
...
module top ;
    ...
    SCB_P4_v1_20_0 I2C_MPU6050 (
        .sclk(Net_1),
        .interrupt(Net_2),
        .clock(1'b0));

    SCB_P4_v1_20_1 SERIAL (
        .sclk(Net_4),
        .interrupt(Net_5),
        .clock(1'b0));
